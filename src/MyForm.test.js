...
describe("Tests EditTimeTable",()=>{
    ...
    it('calls onSubmit prop function when form is submitted', () => {
        ...
        const wrapper2 = shallow(<EditTimeTable onSubmit={onSubmitFn}/>);
